  ...
  render () {
    ...
    return (
      <div className='oo-helper-container'>
        ...
        <div className="oo-helper-button-grp">
        <button className="oo-helper-doit-button btn" ref='pressButton'>Create</button>
        <button className="oo-helper-close-button btn" ref='dismissButton'>Dismiss</button>
        </div>
